export function FamilyToggle({
  ...
  return (
    ...
    >
      <span
        className={`absolute inset-y-0 left-[5px] flex items-center text-[11px] font-bold text-white transition-opacity ${
      ...
      <span
        className={`absolute inset-y-0 right-[5px] flex items-center text-[11px] font-bold text-white transition-opacity ${
      ...
      <span
        ...
        style={{
          transform: isFamily ? "translateX(20px)" : "translateX(0px)",
